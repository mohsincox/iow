    ...
    <div class="dt-content-wrapper">
        ...
        <div class="dt-content">
            ...
            <div class="dt-page__header">
                <h1 class="dt-page__title">Privacy and Policy</h1>
            </div>
            <!-- /page header -->
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title"> Write Here - Privacy and Policy</h3>
                            </div>
                            <!-- /card heading -->
                        ...
                        <div class="dt-card__body">
                            ...
                            <form method="post" action="{{route('admin.privacy_policy')}}">
                                @csrf
                                <textarea id="summernote" name="editordata">{{ (isset($privacy->des )) ? $privacy->des : null}}</textarea>
