    ...
    <div class="dt-content-wrapper">
        ...
        <div class="dt-content">
            ...
            <div class="dt-page__header">
                <h1 class="dt-page__title">Terms and Condition</h1>
            </div>
            <!-- /page header -->
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__header">
                            ...
                            <div class="dt-card__heading">
                                <h3 class="dt-card__title">Write Here - Terms and Condition</h3>
                            </div>
                            <!-- /card heading -->
                        ...
                        <div class="dt-card__body">
                            @if(session()->has('status'))
                                {!! session()->get('status') !!}
                            @endif
                            <form method="post" action="{{route('admin.terms-condition')}}">
                                @csrf
                                <textarea id="summernote" name="editordata">{{ (isset($terms->des )) ? $terms->des : null}}</textarea>
