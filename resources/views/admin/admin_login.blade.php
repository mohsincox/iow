            ...
            <div class="dt-login__content-wrapper">
                ...
                <div class="dt-login__content">
                    ...
                    @endif
                        ...
                        <form action="{{route('admin.login')}} " method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="email-1" aria-describedby="email-1"
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password" class="form-control @error('password') is-invalid @enderror " id="password-1" placeholder="Password" required>
                                @error('password')
                                <strong class="text-danger">{{ $errors->first('password') }}</strong>
                                @enderror
                            </div>

                            <div class="g-recaptcha" data-sitekey="6Lf7UN4UAAAAAF9dUWBHdwm_Up48-z-VJ1eqv78B"></div>
                    ...
                    <div class="dt-login__content-footer">
                        <a href="{{route('forgot-password')}}">Can’t access your account?</a>
                    </div>
                    <!-- /login content footer -->
