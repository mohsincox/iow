    ...
    <div class="dt-content-wrapper">
        ...
        <div class="dt-content">
            ...
            <div class="dt-page__header">
                <h1 class="dt-page__title">Add Purchase Discount</h1>
            </div>
            <!-- /page header -->
                ...
                <div class="col-12">
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__body">
                            @if($PublicFunction::checkPermission($userPermission, ["view_purchase_discount"]))
                                <div class="text-right">
                                    <a href="{{ route('admin.view-purchase-discount') }}" class="btn btn-primary"><i class="icon icon-breadcrumbs"></i> View  Purchase Discount</a>
                                </div>
                            @endif
                            ...
                            <!-- Form -->
                            <form method="post" action="{{route('admin.add-purchase-discount')}}">
                            @csrf
                            <!-- Form Row -->
                                <div class="form-row">
                                    <div class="col-sm-6 mb-3">
                                        <label>Offer Type</label>
                                        <select name="offer_type" id="offer_type" required class="form-control @error('offer_type') is-invalid @enderror">
                                            <option value="" selected>Select a offer type</option>
                                            <option value="lifetime"
                                                    @if(old('offer_type') === "lifetime")
                                                        selected
                                                    @endif
                                            >Lifetime</option>
                                            <option value="specific_time_period" @if(old('offer_type') == "specific_time_period")
                                            selected
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="number" placeholder="Number of purchase"
                                               aria-label="Number of purchase" name="number_of_purchase" min="0" value="{{old('number_of_purchase')}}" required class="form-control @error('number_of_purchase') is-invalid @enderror ">
                                ...
                                <div class="form-row time_period @if( old('offer_type') != null && old('offer_type') == "specific_time_period") @else d-none @endif">
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="purchase_start_date" data-target-input="nearest">
                                                <input type="text" name="purchase_start_date" data-target="#purchase_start_date" value="{{old('purchase_start_date')}}"
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="purchase_end_date" data-target-input="nearest">
                                                <input type="text" name="purchase_end_date" data-target="#purchase_end_date"value="{{old('purchase_end_date')}}"
                                ...
                                <div class="form-row">
                                    <div class="col-sm-6 mb-3">
                                        ...
                                        <input type="number" step="0.01" placeholder="Discount"
                                               aria-label="Discount" name="discount" required min="0" value="{{old('discount')}}" class="form-control @error('discount') is-invalid @enderror ">
                                        @error('discount')
                                        <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-sm-6 mb-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="discount_expire_date"
                                                ...
                                                <input type="text" name="expire_date" required data-target="#discount_expire_date"  value="{{old('expire_date')}}"class="form-control datetimepicker-input @error('expire_date') is-invalid @enderror ">
