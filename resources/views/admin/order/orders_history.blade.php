    ...
    {{--<div class="dt-content-wrapper">--}}
        ...
        {{--<div class="dt-content">--}}
            ...
            {{--<div class="dt-page__header">--}}
                {{--<h1 class="dt-page__title">Orders History</h1>--}}
            {{--</div>--}}
            {{--<!-- /page header -->--}}
            ...
            {{--<div class="row">--}}
                {{--<div class="col-12">--}}
                    {{--<form action="{{ route('admin.get-order-history') }}" method="POST">--}}
                        {{--@csrf--}}
                        {{--<div class="form-row">--}}
                            ...
                            {{--<div class="table pb-10">--}}
                                ...
                                {{--<table id="data-table" class="table table-striped table-bordered table-hover">--}}
                                    ...
                                    {{--<tr>--}}
                                        ...
                                        {{--@if($PublicFunction::checkPermission($userPermission, ["order_details"]))--}}
                                            {{--<th>Option</th>--}}
                                        {{--@endif--}}
                                    {{--</tr>--}}
                                    {{--</thead>--}}
                                    ...
                                    {{--@foreach($orders As $key => $value)--}}
                                        {{--<tr class="gradeX">--}}
                                            {{--<td>--}}
                                                {{--<a href="{{ route('admin.order.details', $value->id) }}">{{ $value->id }}</a>--}}
                                            {{--</td>--}}
                                            {{--<td>{{ $value->name }}</td>--}}
                                            {{--<td>{{ $value->phone }}</td>--}}
                                            ...
                                            {{--@if($PublicFunction::checkPermission($userPermission, ["order_details"]))--}}
                                                {{--<td>--}}
                                                    {{--<a href="{{ route('admin.order.details', $value->id) }}" class="btn btn-info btn-sm p-2">Details</a>--}}
                                                {{--</td>--}}
                                            {{--@endif--}}
                                        {{--</tr>--}}
                                    {{--@endforeach--}}
...
@section('content')
    <div class="dt-content-wrapper">
        ...
        <div class="dt-content">
            ...
            <!-- Page Header -->
            <div class="dt-page__header">
                <h1 class="dt-page__title">Order History</h1>
            </div>
            <!-- /page header -->
    ...
    <script>
      ...
      $(document).ready( function () {
        ...
        tbl = $('#data-table').DataTable({
          ...
          order: [[ 0, "desc" ]],
          "ajax":{
            "url": "{{ route('admin.order-history-data') }}",
            "dataType": "json",
            "type": "POST",
              ...
              'render': function(data, type, row, meta){
                ...
                if(type === 'display') {
                  if(row.status === "Cancelled") {
                    mm = '<span class="badge badge-danger">' + row.status + '</span>'
                  }else{
                    mm = '<span class="badge badge-success">' + row.status + '</span>'
                  }
                }
                return mm;
              },
