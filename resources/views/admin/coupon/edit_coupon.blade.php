    ...
    <div class="dt-content-wrapper">
        ...
        <div class="dt-content">
            ...
            <div class="dt-page__header">
                <h1 class="dt-page__title">Edit Coupon</h1>
            </div>
            <!-- /page header -->
                ...
                <div class="col-12">
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__body">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{route('admin.edit-coupon', $coupon->id )}}">
                            @csrf
                            <!-- Form Row -->
                                <div class="form-row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="code" id="couponCode" required readonly value="{{ $coupon->code }}" class="form-control text-uppercase @error('code') is-invalid @enderror " maxlength="6">
                                            <div class="input-group-append">
                                                <button class="btn btn-outline-primary" disabled type="button" onclick="generateCoupon()">Generate</button>
                                            </div>
                                        </div>
                                        @error('code')
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="discount" id="discount" required readonly value="{{ $coupon->discount }}" class="form-control @error('discount') is-invalid @enderror ">
                                        </div>
                                        @error('discount')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="date-time-picker-6"
                                        ...
                                        <input type="text" name="expire_date" placeholder="End Time" value="{{ date('m/d/Y h:i A', strtotime($coupon->expire_date)) }}" class="form-control datetimepicker-input"
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="checkbox" name="is_public" id="is_public" value="0" class="@error('is_public') is-invalid @enderror" @if($coupon->is_public =='0') checked @endif style="height: 25px; width: 25px;">
                                        </div>
                                        @error('is_public')
                                        <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
