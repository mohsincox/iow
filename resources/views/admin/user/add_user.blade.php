    ...
    <div class="dt-content-wrapper">
        ...
        <div class="dt-content">
            ...
            <div class="dt-page__header">
                <h1 class="dt-page__title">Add User</h1>
            </div>
            <!-- /page header -->
                ...
                <div class="col-12">
                    ...
                    <div class="dt-card">
                        ...
                        <div class="dt-card__body">
                            @if($PublicFunction::checkPermission($userPermission, ["view_user"]))
                                <div class="text-right mb-1">
                                    <a href="{{ route('admin.view-user') }}" class="btn btn-primary"><i class="icon icon-breadcrumbs"></i>View User List</a>
                                </div>
                            @endif
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <div class="input-group">
                                            <input type="text"  placeholder="Name"
                                                   aria-label="Username" name="name" required value="{{old('name')}}" class="form-control @error('name') is-invalid @enderror ">
                                            @error('name')
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <div class="input-group">
                                            <input type="number"  placeholder="Phone"
                                                   aria-label="Userphone" name="phone" required value="{{old('phone')}}" class="form-control @error('phone') is-invalid @enderror">
                                            @error('phone')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <div class="input-group">
                                            <input type="email"  placeholder="Email"
                                                   aria-label="Useremail" name="email" required value="{{old('email')}}" class="form-control @error('email') is-invalid @enderror " >
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-10 col-sm-9">
                                        <div class="input-group">
                                            <input type="password"  placeholder="Password"
                                                   aria-label="Userpassword" name="password" required value="{{old('password')}}" class="form-control @error('password') is-invalid @enderror ">
                                            @error('password')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
