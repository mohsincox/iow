                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 offset-md-6 col-lg-6 offset-lg-7">
                            <div class="slider_content">
                                ...
                                <h2 class="slider-content-h2">{!! (isset($slide->des))? $slide->des : "" !!}</h2>
                                @if($slide->btn_name)
                                <a class="button slider-content-btn" href="{{ (isset($slide->btn_link))? $slide->btn_link : "" }}">{{ (isset($slide->btn_name))? $slide->btn_name : "" }}</a>
                                    @else
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="add_to_cart">
                        <a class="shopping_cart_link mr-2" id="{{ $package->id }}"
                            ...
                            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                                 viewBox="0 0 24 19.7" class="svg-enb-bg" xml:space="preserve">
                                <style type="text/css">
                                    .st0{fill:#FFFFFF;}
                                </style>
                                <g>
            ...
            <div class="modal-content">
                ...
                <form action="" method="">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary btn-sm cart-popup-shopping-btn modal-f-btn">Continue Shopping</button>
                        <button type="button" class="btn btn-primary btn-sm cart-popup-checkout-btn modal-f-btn">View Cart</button>
                    </div>
                </form>
                <!-- /modal footer -->
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
                ...
                <form action="" method="">
                    ...
                    <!-- Modal Footer -->
                    <div class="modal-footer">
                        <button type="button" class="btn btn-primary btn-sm add-customer-phone-btn modal-f-btn" disabled >Save</button>
                    </div>
                </form>
                <!-- /modal footer -->
